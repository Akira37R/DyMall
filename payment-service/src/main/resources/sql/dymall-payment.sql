CREATE DATABASE IF NOT EXISTS `dymall-payment` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION = 'N' */;
USE `dymall-payment`;
...
(
  ...
  AUTO_INCREMENT = 1659160218174607364
  DEFAULT CHARSET = utf8mb3 COMMENT ='支付订单';

DELETE
FROM `pay_order`;
INSERT INTO `pay_order` (`id`, `biz_order_no`, `pay_order_no`, `biz_user_id`, `pay_channel_code`, `amount`, `pay_type`,
                         `status`, `expand_json`, `result_code`, `result_msg`, `pay_success_time`, `pay_over_time`,
                         `qr_code_url`, `create_time`, `update_time`, `creator`, `updater`, `is_delete`)
VALUES (1658455441987891201, 1658453559437434882, 1658455441975308289, 1, 'balance', 55400, 5, 3, '', '', '',
        '2023-05-16 21:14:57', '2023-05-16 22:52:45', NULL, '2023-05-16 20:52:44', '2023-05-18 19:38:03', 0, 0, b'0'),
       (1659160218174607363, 1659160216593354754, 1659160218174607362, 1, 'balance', 156000, 5, 3, '', '', '',
        '2023-05-18 19:34:48', '2023-05-18 21:33:16', NULL, '2023-05-18 19:33:16', '2023-05-18 19:37:54', 0, 0, b'0');
